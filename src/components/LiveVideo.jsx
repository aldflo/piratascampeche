            ...
            >
              ...
              >
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[8px] font-black uppercase tracking-[0.14em] text-white sm:text-[10px]">
                    Marcador
                  </span>
                </div>

                <span className="rounded-md bg-yellow-300/10 px-1.5 py-0.5 text-[9px] font-black text-yellow-300 sm:text-xs">
              ...
              >
                <div className="min-w-0">
                  <p className="text-[7px] font-bold uppercase tracking-wider text-slate-500 sm:text-[9px]">
                    Visitante
                  </p>
                ...
                <div className="flex items-center gap-1.5 sm:gap-3">
                  ...
                  <span className="text-[9px] font-black text-slate-600 sm:text-xs">
                    -
                  </span>

                  <span className="text-xl font-black leading-none text-yellow-300 sm:text-3xl">
                ...
                <div className="min-w-0 text-right">
                  ...
                  <p className="truncate text-[11px] font-black text-yellow-300 sm:text-sm">
                    {marcador.local}
                  </p>
                </div>
              </div>

              {/* Conteo, mucho más pequeño en móvil */}
              <div
                className="
                  flex
                  items-center
                ...
                "
              >
                <span className="min-w-0 truncate text-[8px] font-bold text-slate-400 sm:text-[10px]">
                  Batea:{" "}
                ...
                <div className="flex shrink-0 items-center gap-1.5 text-[8px] font-black sm:gap-3 sm:text-[10px]">
